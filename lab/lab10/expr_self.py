...
class CallExpr(Expr):
    ...
    def eval(self, env):
        ...
        operands_val_list = [o.eval(env) for o in self.operands]
        return operator_val.apply(operands_val_list)
...
class Number(Value):
    ...
    def apply(self, arguments):
    	raise TypeError("Cannot apply number {} to arguments {}"
    		.format(self.value, comma_separated(arguments)))
...
class LambdaFunction(Value):
    ...
    def apply(self, arguments):
        ...
        if len(arguments) != len(self.parameters):
        	raise TypeError("Cannot match parameters {} to arguments {}"
        		.format(comma_separated(self.parameters),comma_separated(arguments)))
